    ...
    <div data-testid="b2b-page">
      ...
      <section className="bg-[#1F3D2B] text-[#F5F1E8] px-4 sm:px-5 md:px-10 py-16 sm:py-20 md:py-24 lg:py-32 border-b-[3px] border-[#1F3D2B] relative overflow-hidden">
        <div className="max-w-5xl relative z-10">
          <motion.div initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:0.6}}>
            <div className="inline-flex items-center gap-2 text-xs sm:text-sm font-black uppercase tracking-[0.16em] text-[#D98F00] border-2 border-[#D98F00] px-3 sm:px-4 py-1.5 sm:py-2 mb-4 sm:mb-6">
      ...
      <section className="px-4 sm:px-5 md:px-10 py-12 md:py-20 bg-[#F5F1E8]">
        <motion.div initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} viewport={{once:true}} className="mb-8 md:mb-12">
          <div className="text-xs sm:text-sm font-black uppercase tracking-[0.18em] text-[#B8431A]">Why Partner With Us</div>
      ...
      <section className="px-4 sm:px-5 md:px-10 py-12 md:py-20 bg-[#D98F00] border-y-[3px] border-[#1F3D2B]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 items-start max-w-6xl mx-auto">
          ...
          <motion.div initial={{opacity:0,x:-30}} whileInView={{opacity:1,x:0}} viewport={{once:true}} className="bg-[#F5F1E8] border-[3px] border-[#1F3D2B] p-5 sm:p-6 md:p-8 brutal-shadow-lg">
            <div className="text-xs sm:text-sm font-black uppercase tracking-[0.18em] text-[#B8431A]">Volume Discounts</div>
          ...
          {sent ? (
            ...
            <motion.form onSubmit={submit} initial={{opacity:0,x:30}} whileInView={{opacity:1,x:0}} viewport={{once:true}} data-testid="b2b-form" className="border-[3px] border-[#1F3D2B] bg-white p-4 sm:p-6 md:p-8 brutal-shadow">
              <div className="text-xs sm:text-sm font-black uppercase tracking-[0.18em] text-[#B8431A]">Get Started</div>
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <label>
                    <div className="text-xs sm:text-sm font-black uppercase tracking-[0.16em] text-[#1F3D2B] mb-1">Company / Outlet</div>
                  ...
                  <label>
                    <div className="text-xs sm:text-sm font-black uppercase tracking-[0.16em] text-[#1F3D2B] mb-1">Your Name</div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <label>
                    <div className="text-xs sm:text-sm font-black uppercase tracking-[0.16em] text-[#1F3D2B] mb-1">Email</div>
                  ...
                  <label>
                    <div className="text-xs sm:text-sm font-black uppercase tracking-[0.16em] text-[#1F3D2B] mb-1">Phone</div>
                ...
                <label>
                  <div className="text-xs sm:text-sm font-black uppercase tracking-[0.16em] text-[#1F3D2B] mb-1">Monthly Volume (Litres)</div>
                ...
                <label>
                  <div className="text-xs sm:text-sm font-black uppercase tracking-[0.16em] text-[#1F3D2B] mb-1">Message (Optional)</div>
              ...
              {error && <p className="mt-3 text-sm font-bold text-[#B8431A]">{error}</p>}
              <p className="mt-3 sm:mt-4 text-xs sm:text-sm text-[#1F3D2B]/60 text-center">We typically respond within 4 business hours.</p>
            </motion.form>
          )}
        </div>
      </section>
